...
The Riverscapes Command Line Interface (rscli) is a small, lightlight application for interacting with the [Riverscapes Data Exchange](https://data.riverscapes.net) and the associated [API](./index). Using rscli simplifies the process of uploading and downloading data from the Riverscapes Data Exchange. It handles authenticating your user account and validating data uploads.
