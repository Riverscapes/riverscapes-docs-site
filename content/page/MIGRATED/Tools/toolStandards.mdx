...
<Image float="left" src="/images/RC/organic.png" /> The RC's [tool grades](/Tools/discrimination.html), as an example of standards, can make claims as to utility. However, _who_ makes that claim or has the authority to do so matters. 
