...
The Riverscapes Consortium organizes and serves data via the  *[Data Exchange](http://data.riverscapes.net)*. The Data Exchange provides access to both the underlying data (packaged in [riverscapes projects](/Tools/Technical_Reference/Documentation_Standards/Riverscapes_Projects/)) as well as making these data explorable via a  [warehouse explorer](/Data_Warehouses/#warehouse-explorer-concept) or [interactive web maps](/Data_Warehouses/#web-maps). We only serve and host data packaged in fully  [Riverscapes-Compliant](/Tools) <img src="/img/rc/RiverscapesCompliant_24.png" />  [Riverscapes Projects](/Tools/Technical_Reference/Documentation_Standards/Riverscapes_Projects/) <img src="/img/data/RiverscapesProject_24.png" />.

## Goal 

<img src="/img/data/RiverscapesWarehouseCloud_128.png" />
Make it easier to catalog, share, discover and retrieve the products of riverscapes analysis and modelling.

<button imgrc="/img/data/RiverscapesWarehouseCloud_32png.png" to="http://data.riverscapes.net" title="Get Data Now from Riverscapes Warehouse"/>
...
- Custom field and desktop [Apps](/Data_Warehouses#apps---pwas) <img src="/img/tools/PWA.png" />
- Secure cloud hosting  (typically in <img src="/img/data/aws_24.png" to="https://aws.amazon.com"/> [S3](https://aws.amazon.com/s3/faqs/)) with:
  - Easy public sharing
  - Full user access permission control
- Full <img src="/img/data/aws_24.png" to="https://aws.amazon.com" />  integration with [EC2](https://aws.amazon.com/ec2/?nc2=type_a) and [Lambda](https://aws.amazon.com/lambda/?nc2=type_a) for cloud-computing of [Production-Grade](https://riverscapes.github.io/riverscapes-website/Tools/#tool-status) Riverscapes Models.
-  [Creative Commons licensing](https://creativecommons.org/licenses/) of datasets
- Ability to mint [DOIs](https://www.doi.org/faq.html) <img src="/img/data/DOI_24.png" to="https://www.doi.org/faq.html"/> to make datasets citable
- [OGC API](http://www.ogcapi.org/) access to riverscapes projects and warehouse for programmers <img src="/img/data/api_24.png" />
...
<img src="/img/data/RC_WarehouseExplorer.png" to="https://northarrowresearchlabs.github.io/riverscapes/#/" />

Part of the advantage of serving and hosting data in the [Riverscapes Warehouse](http://data.riverscapes.net)  <img src="/img/data/RiverscapesWarehouseCloud_24.png" /> is the ability to catalog and index the data so it easily searchable,  queried and discoverable.

<img src="/img/data/WarehouseCHAMP.png" noWrap />
...
<img  src="/img/data/PWA_LTPBR_Design3.png" />

The future of App develpoment to work across platforms (i.e. iOS, Android, Windows, Linux, etc.) is in progressive web-apps (PWAs) <img noWrap src="/img/tools/PWA.png" />. Another advantage of hosting  your [Riverscapes Projects](/Tools/Technical_Reference/Documentation_Standards/Riverscapes_Projects/) <img  src="/img/data/RiverscapesProject_24.png" /> in a Riverscapes Warehouse  <img src="/img/data/RiverscapesWarehouseCloud_24.png" />, is that PWA(s) can be developed and deployed to make field or desktop interactive apps to allow users to collect data, do analysis and have it direclty interact with and even update a Riverscapes Project.
...
<img src="/img/data/PWA_LTPBR_Design2.png" />
...
How the data datasets were generated
  ...
  -  **Automated Cloud -** Generated via cloud processing engines (e.g., <img noWrap src="/img/data/aws_24.png" to="https://aws.amazon.com"/> EC2 or Lambda)
