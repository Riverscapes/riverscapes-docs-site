...
description: An application to help with repeat photography monitoring
---
...
In 2021, North Arrow Research and Utah State University collaborated on a NASA-funded initiative to develop a repeat photography app, primarily to support riverscape monitoring, but more broadly for anyone interested in capturing environmental change. The project ran for four years, and we successfully produced [Phlux](https://phlux.riverscapes.net), an app for Android and iOS capable of capturing photos offline and synchronizing them to the cloud once a device regains service.
...
![phlux](/img/products/phlux/phlux.png)
...
Phlux is still available as a web application at [phlux.riverscapes.net](https://phlux.riverscapes.net). Given that Phlux was developed with a mobile-first user experience in mind, so some interface elements may feel a little unusual on desktop, but it remains functional.
...
1. Open your browser on your mobile device (or desktop) and visit [phlux.riverscapes.net](https://phlux.riverscapes.net). We recommend Chrome, but Safari on iOS devices work too.
3. Open your browser menu and select "Install..." or "Save to Desktop...". This installs the website as an app on your device and should add an icon to your home screen.
4. Look for the Phlux icon on your device desktop. Open it and sign in.
