---
title: How to Merge Riverscapes Projects
...
Copy the collection ID from the collection page using the Copy to clipboard button on the Collection page, as shown:

![Copy Collection ID from Data Exchange UI](/img/data-exchange/dataex_copy_collectionID_screenshot.min.png)
