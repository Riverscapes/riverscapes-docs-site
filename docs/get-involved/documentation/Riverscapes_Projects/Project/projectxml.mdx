...
:::warning[Legacy V1 Schema]
This page describes the **V1** project XML schema, which is the original format. The current standard is **V2**, documented at the [RiverscapesXML repository](https://github.com/Riverscapes/RiverscapesXML). For new projects, refer to the [V2 XSD](https://raw.githubusercontent.com/Riverscapes/RiverscapesXML/master/Projects/XSD/V2/RiverscapesProject.xsd) and the standards [index page](/standards) for current guidance.
:::

Validating your `project.rs.xml` file against the V1 schema can be done using the following URL:
...
```
https://raw.githubusercontent.com/Riverscapes/RiverscapesXML/master/Projects/XSD/V2/RiverscapesProject.xsd
```
