...
* (Internal) Draft [Table of Contents Google Doc](https://docs.google.com/spreadsheets/d/1z2zneBdZIrL2vqD4iJ_hSQAqQuD0YbwzHP250B2_AVw/edit?usp=sharing)
* (Internal) the communication guide for information about our writing style ([early draft in Google Docs](https://docs.google.com/document/d/16Xp0VH2yHCJ0UdAcAnX1SE1KsCM9y6mUbl4HtCL_cqI/edit?usp=sharing))
* Design style guide for information about our visual identity (already on this site)
* [technical guide to our docusaurus sites](using-docusaurus)
...
* How-tos should use active voice. 
	* _How to create a riverscapes project_ ✅ 
	* **not** _Creating a riverscapes project_ ❌
	* **not** _Riverscapes projects_ ❌
...
![algolia screenshot](/img/get-involved/docusaurus-example-algolia-screenshot.png)
