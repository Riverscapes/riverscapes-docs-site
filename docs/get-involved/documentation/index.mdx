...
Description of individual fields (columns) can be included in various ways depending on the format of the data. For Geopackages, see [[providing field-level metadata via Geopackages]].
