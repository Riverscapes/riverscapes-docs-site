...
![Add To Map](/img/standards/viewer/add_to_map.png)
...
![symbology keys](/img/standards/viewer/symbology_keys.png)
...
![appdata](/img/standards/viewer/appdata.png)
...
![layer file](/img/standards/viewer/layer_file.png)
