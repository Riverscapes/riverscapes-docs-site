...
- **Metadata** - list of key value pairs. Useful values are:
  - **Resolution** - For example, whether the individual data records represent reaches, sub-catchments, or some other unit of analysis.
  ...
  - **Model Status** - see Riverscapes Data Exchange [Model Statuses](TODO) for more information.
...
:::info
  ...
  vertices is best. A good benchmark is to keep the GeoJSON file well under 500kb.
:::
