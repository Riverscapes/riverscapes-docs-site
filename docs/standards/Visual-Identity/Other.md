...
Any file placed in the `static` directory (e.g., `static/img/avatars/jane.png`) of the riverscapes docs site repo (**[https://github.com/Riverscapes/riverscapes-docs-site](https://github.com/Riverscapes/riverscapes-docs-site)**) is automatically served at a public URL when the site is built and deployed. This means you can use these images in markdown, HTML, or anywhere a direct link is needed.
...
```text
static/img/people/joe_wheaton_cartoon.png
```

The image will be available at:

```text
https://docs.riverscapes.net/img/people/joe_wheaton_cartoon.png
```
...
- **Casual Sharing:** The `static` folder is intended for simple distribution of images (e.g., avatars, screenshots, diagrams) for use by Riverscapes sites and apps.
- **File Naming:** Think carefully about file and folder names. Do not use spaces. Try to standardize on all lower case.
