...
The Riverscapes Consortium is NOT a government agency nor it is a legal entity. However, the RC is working to earn the trust of the riverscapes community it supports, through clear standards, transparency and making sure our badges should mean something to end-users. When the [Riverscapes-Compliant](/Tools/#riverscapes-compliant) badge has been issued, it communicates that a standard has been met, and verified by the Riverscapes Consortium. 

<img to="/discrimination" src="/img/tools/grade/Tool_Badges_wText_All_700w.png" />
