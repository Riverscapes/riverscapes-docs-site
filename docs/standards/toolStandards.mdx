...
Tool standards help potential audiences understand and manage expectations around what a tool can and cannot do "as-is", versus what it could be able to do with investment in development and deployment. In this 20 minute video, Joe Wheaton introduces how the Riverscape Consortium sets standards for [tool development](https://riverscapes.net/Tools/) and the idea of [tool-grade](discrimination/#tool-grade). 

<YouTubeEmbed videoId="wcT4vSZmQa0" caption="Riverscapes Tool Standards Explained" />

## Meaning Behind a Standard

The RC's [tool grades](discrimination), as an example of standards, can make claims as to utility. However, _who_ makes that claim or has the authority to do so matters. 
