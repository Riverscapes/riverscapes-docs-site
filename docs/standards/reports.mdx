...
The system currently uses data from the [2025 conterminous United States model run](/initiatives/2025-CONUS-runs.md) that includes metrics for over 54,000,000 riverscapes segments.
...
The Riverscapes reports platform uses data produced by the [2025 run of the riverscapes network models](/initiatives/2025-CONUS-runs.md). More specifically, it uses our custom database of [RME metrics](https://tools.riverscapes.net/rme/data) for approximately 54,000,000 DGOs across the conterminous USA.
